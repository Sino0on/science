# Generated by Django 4.2.3 on 2023-08-09 08:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_en', models.CharField(max_length=123, null=True, verbose_name='Название')),
                ...
                ('disciplines', models.ManyToManyField(to='server.profession')),
                ('members', models.ManyToManyField(related_name='projects', to='server.author', verbose_name='Участники')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages_chat', to='server.chat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_ru', models.TextField(null=True, verbose_name='Описание')),
                ('description_ky', models.TextField(null=True, verbose_name='Описание')),
                ('pdf', models.FileField(blank=True, null=True, upload_to='files/materials/%Y/%m/%d/', verbose_name='PDF файл')),
                ('youtube', models.URLField(blank=True, null=True, verbose_name='Ютуб ссылка')),
                ('image', models.ImageField(blank=True, null=True, upload_to='images/materials/%Y/%m/%d/', verbose_name='Название')),
                ('authors', models.ManyToManyField(related_name='materials', to='server.author', verbose_name='Авторы')),
                ('disciplines', models.ManyToManyField(to='server.profession')),
